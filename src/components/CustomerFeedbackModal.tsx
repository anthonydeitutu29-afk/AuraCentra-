...
export const CustomerFeedbackModal: React.FC<CustomerFeedbackModalProps> = ({
 ...
 className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white text-xs font-bold shadow-md transition-all cursor-pointer disabled:opacity-50"
 >

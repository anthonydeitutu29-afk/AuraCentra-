...
interface AboutPageProps {
 ...
 onNavigateSection?: (section: 'about' | 'pricing' | 'verification' | 'terms' | 'support' | 'home') => void;
}
...
export const AboutPage: React.FC<AboutPageProps> = ({
 ...
 const handleTabClick = (tab: 'about' | 'pricing' | 'verification' | 'terms' | 'support') => {
   if (onNavigateSection) {
     onNavigateSection(tab);
   } else {
     if (tab === 'about' || tab === 'pricing' || tab === 'verification' || tab === 'terms') {
       setActiveTab(tab);
     }
   }
 };
 ...
 className="flex-1 sm:flex-none px-5 py-3 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
 >
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shadow-md transition-all cursor-pointer"
 >
 ...
 {/* Gold Verified */}
 <div className="p-6 rounded-3xl border-2 border-blue-600 bg-blue-50/40 dark:bg-blue-950/40 space-y-5 relative shadow-lg flex flex-col justify-between">
 ...
 type="button"
 onClick={onOpenRegister}
 className="w-full py-3 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold shadow-md transition-all cursor-pointer"
 >
 ...
 type="button"
 onClick={onOpenRegister}
 className="px-5 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-md transition-all cursor-pointer flex items-center gap-1.5"
 >
 <ShieldCheck className="w-4 h-4" />

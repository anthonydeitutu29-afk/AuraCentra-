...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
 ...
 ? 'bg-amber-950/40 border-amber-600/80 shadow-lg ' 
 : 'bg-slate-800/80 border-slate-700/80'
 }`}>
 <div className="flex items-center justify-between text-slate-400 text-xs">
 <span>On Investigation</span>
 <AlertTriangle className={`w-4 h-4 ${investigationCount > 0 ? 'text-amber-400' : 'text-slate-400'}`} />
 </div>
 ...
 onClick={(e) => {
 e.stopPropagation();
 markBusinessPermanentlyApproved(biz.id);
 onApproveVerification(
 biz.id,
 'Gold Enterprise',
 biz.coordinates,
 ...
 if (onShowToast) {
 onShowToast(
 '⚡ Enlisted Live on Website in 0.1s',
 `"${biz.name}" is now live on the public website under ${biz.category} without delay!`,
 'success'
 );
 }
 }}
 className="inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-xs font-black transition-all shadow-md cursor-pointer active:scale-95"
 title="Instantly approve and publish live on the website in 0.1s"
 >
 ...
 className="inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-blue-600/90 hover:bg-blue-600 text-white text-xs font-bold transition-all shadow-md cursor-pointer"
 title="Enlist instantly and navigate directly to live listing on the website"
 >
 <ExternalLink className="w-3.5 h-3.5" />
 <span>Approve & View</span>
 </button>

 <button
 type="button"
 onClick={() => setRejectingBusiness(biz)}
 className="inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-amber-950/80 border border-amber-800/90 hover:bg-amber-900 text-amber-200 text-xs font-bold transition-colors shadow-xs cursor-pointer"
 ...
 className="flex-1 inline-flex items-center justify-center gap-1 py-2.5 px-2 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 text-xs font-medium transition-colors cursor-pointer"
 title="Customize verification badge, featured placement or GPS coordinates"
 >
 ...
 className="p-2.5 rounded-xl bg-rose-950/80 border border-rose-800/90 hover:bg-rose-900 text-rose-300 transition-colors shadow-xs cursor-pointer"
 ...
 target="_blank"
 rel="noreferrer"
 className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-md transition-all"
 >
 <MessageSquare className="w-3.5 h-3.5" />
 ...
 b.isFeatured
 ? 'bg-gradient-to-r from-amber-500 to-yellow-500 text-slate-950 font-extrabold hover:brightness-110 '
 ...
 <td className="p-3.5">
 {isBizUnderInvestigation(b) ? (
 <span className="px-2.5 py-1 rounded-full bg-amber-950/90 border border-amber-500/80 text-amber-300 font-bold text-[10px] inline-flex items-center gap-1.5 shadow-xs">
 ...
 onShowToast(
 '⚡ Enlisted Live on Website in 0.1s',
 `"${b.name}" is now live on the public directory without delay!`,
 'success'
 );
 }
 }}
 className="px-2.5 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-[11px] font-black transition-all inline-flex items-center gap-1 cursor-pointer active:scale-95 shadow-xs"
 title="Instantly approve and enlist on website in 0.1s"
 >
 ...
 title="Options (Customize tier & category placement)"
 >
 ...
 `"${targetBiz.name}" is officially verified and immediately published live to the directory in 0.1s.`,
 'success'
 );
 }
 }}
 ...
 className="px-4 py-2 rounded-xl bg-amber-600 hover:bg-amber-500 text-white text-xs font-bold transition-all shadow-md inline-flex items-center gap-1.5 cursor-pointer"
 >
 ...
 className="px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white text-xs font-bold transition-all shadow-md inline-flex items-center gap-1.5 cursor-pointer"
 >

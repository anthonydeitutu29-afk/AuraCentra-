                      ...
                      <div className="pt-3 border-t border-slate-700/80 space-y-2">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                          <button
                            ...
                            className="inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-xs font-black transition-all shadow-md shadow-emerald-950/40 cursor-pointer active:scale-95"
                          ...
                          <button
                            ...
                            className="inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-blue-600/90 hover:bg-blue-600 text-white text-xs font-bold transition-all shadow-md shadow-blue-950/40 cursor-pointer"

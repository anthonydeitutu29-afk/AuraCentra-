...
export const GhanaBusinessNewsSection: React.FC<GhanaBusinessNewsSectionProps> = ({
 ...
 className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0a1c47] via-[#103b9b] to-[#0c2461] border-2 border-blue-300/40 dark:border-blue-500/40 p-6 sm:p-8 shadow-2xl hover: hover:border-white/70 transition-all duration-300 cursor-pointer text-white"
 >

...
export const BusinessRegistrationModal: React.FC<BusinessRegistrationModalProps> = ({
 ...
 className="flex-1 py-3 px-4 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-xs sm:text-sm font-bold shadow-lg transition-all cursor-pointer flex items-center justify-center gap-1.5"
 >

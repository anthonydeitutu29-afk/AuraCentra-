...
export const AccountSettingsModal: React.FC<AccountSettingsModalProps> = ({
 ...
 className="w-full sm:w-auto px-6 py-3 rounded-xl bg-rose-600 hover:bg-rose-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-black shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer"
 >
 {isDeleting ? (
 <>

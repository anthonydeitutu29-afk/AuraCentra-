...
export const LocationMapModal: React.FC<LocationMapModalProps> = ({
 ...
 <div className="p-2 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-800 text-white shadow-md ">
 ...
 className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-95 text-white text-xs font-bold shadow-xs transition-all"
 >

        ...
        <div className="grid grid-cols-5 items-center justify-between max-w-md mx-auto">
          ...
          <div className="flex flex-col items-center justify-center">
            <button
              ...
              className="w-11 h-11 -mt-5 rounded-full bg-[#155DFC] hover:bg-blue-700 text-white flex items-center justify-center shadow-lg shadow-blue-500/35 border-2 border-white dark:border-slate-900 active:scale-90 transition-all cursor-pointer"
              title="Enlist Your Business"
              aria-label="Enlist Business"
            >
              <PlusCircle className="w-6 h-6" />
            </button>
            <span className="text-[10px] font-bold text-[#155DFC] dark:text-[#38BDF8] mt-0.5 tracking-tight">Enlist</span>
          </div>
            ...
            <div className="space-y-1.5 text-xs font-bold">
              ...
              >
                <span className="flex items-center gap-2.5">
                  <MessageSquare className="w-4 h-4 text-[#155DFC] dark:text-[#38BDF8]" />
                  <span>Client Quotes & Inquiries</span>
                </span>
                {inquiriesCount > 0 && (
                  <span className="px-2 py-0.5 rounded-full bg-[#155DFC] text-white font-extrabold text-[10px]">
                    {inquiriesCount} New
                  </span>
                )}
              </button>
              ...
              {currentUser && (currentUser.role === 'business_owner' || currentUser.role === 'verified_owner' || (currentUser.ownedBusinessIds && currentUser.ownedBusinessIds.length > 0)) && onOpenBusinessDashboard && (
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 rounded-2xl bg-slate-900 dark:bg-slate-800 text-white font-bold transition-all shadow-xs border border-slate-700/60 cursor-pointer"
                >
                  <span className="flex items-center gap-2.5">
              ...
              {currentUser && currentUser.role === 'customer' && onOpenPersonalDashboard && (
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 rounded-2xl bg-blue-600 text-white font-bold transition-all shadow-xs cursor-pointer"
                >
                  <span className="flex items-center gap-2.5">
              ...
              {onToggleTheme && (
                ...
                >
                  ...
                  <span className="px-2.5 py-1 rounded-lg bg-blue-600/10 dark:bg-blue-950 text-blue-700 dark:text-blue-300 text-[11px] font-bold border border-blue-200 dark:border-blue-800">
              ...
              {onOpenPricing && (
                ...
                >
                  <span className="flex items-center gap-2.5">
                    <Building2 className="w-4 h-4 text-blue-600 dark:text-[#38BDF8]" />
                    <span>Pricing & Enlistment Packages</span>
                  </span>
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-100 dark:bg-blue-950 text-blue-800 dark:text-[#38BDF8] font-bold">
                    Free / Pro
                  </span>
                </button>
              )}

              {/* Ghana Card Verification Link */}
              {onOpenVerification && (
                <button
                  type="button"
                  onClick={() => {
              ...
              {onOpenTerms && (
                ...
                >
                  <span className="flex items-center gap-2.5">
                    ...
                    <span>Terms & Trust Standards</span>
                  </span>
            ...
            <div className="pt-2 space-y-2">
              {currentUser ? (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 p-3.5 rounded-2xl bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 text-white font-bold text-xs shadow-xs border border-slate-700/60 transition-all cursor-pointer"
                >

...
export const VerificationCertificateModal: React.FC<VerificationCertificateModalProps> = ({
 ...
 className="w-full sm:flex-1 py-3 px-4 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white font-bold text-xs sm:text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
 >
